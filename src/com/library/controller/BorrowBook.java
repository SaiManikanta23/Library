...
public class BorrowBook extends JFrame {
	 ...
	 * Create the frame.
	 */
	public BorrowBook(Library library, User customer) {
		...
		btnBorrow.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (BorrowBook.this.library==null)
					return;
				...
				boolean suc = BorrowBook.this.library.rentBook(BorrowBook.this.customer.getUserId(), book.getIsbn());
				BorrowBookFinish dlgBorrowFinish = new BorrowBookFinish(suc,book);
				dlgBorrowFinish.setModal(true);
				dlgBorrowFinish.setVisible(true);
				BorrowBook.this.refreshBookTableUI();
			}	
		});
