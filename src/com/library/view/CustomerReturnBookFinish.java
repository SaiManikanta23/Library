...
public class CustomerReturnBookFinish extends JDialog{
	...
	CustomerReturnBookFinish(){

	}
	
	public CustomerReturnBookFinish(double fine){
		...
		btnOK.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae){
				CustomerReturnBookFinish.this.dispose();
			}
		});
	}
}
