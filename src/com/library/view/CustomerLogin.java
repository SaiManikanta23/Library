...
public class CustomerLogin extends JFrame{
	...
	public CustomerLogin(Library l){
		this.library=l;
		...
		btnLogin.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae){
				...
				if(user.length() == 0){
					JOptionPane.showMessageDialog(CustomerLogin.this, "Please enter your username.", "Login Failed", JOptionPane.ERROR_MESSAGE);
				} else{
					if(pwd.length() == 0){
						JOptionPane.showMessageDialog(CustomerLogin.this, "Please enter your password.", "Login Failed", JOptionPane.ERROR_MESSAGE);
					} else{
						currentUser = library.login(user, pwd);
						if(currentUser != null){
							if(!currentUser.isAdmin()){
								JOptionPane.showMessageDialog(CustomerLogin.this, "Welcome, " + currentUser.getUserName() + "!", "Welcome", JOptionPane.INFORMATION_MESSAGE);
								CustomerLogin.this.dispose();
								new CustomerInterface(library, currentUser);
							} else{
								JOptionPane.showMessageDialog(CustomerLogin.this, "Invalid username or password.", "Login Failed", JOptionPane.ERROR_MESSAGE);
								pwdPassWord.setText("");
							}
						} else{
							JOptionPane.showMessageDialog(CustomerLogin.this, "Invalid username or password.", "Login Failed", JOptionPane.ERROR_MESSAGE);
	...
	public CustomerLogin(Object object) {
