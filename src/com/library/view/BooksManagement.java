...
//Books Management Frame, Including Adding Updating and Deleting. 
...
public class BooksManagement extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5810752996513863532L;
	...
	public void Refresh(){
		...
		switch (viewBookType) {
		case All:
			books= BooksManagement.this.library.showBookList_all();
			break;
		case Rented:
			books=BooksManagement.this.library.showBookList_rented();
			break;
		case NotRented:
			books=BooksManagement.this.library.showBookList_remainder();
			break;
		case Overdue:
			books=BooksManagement.this.library.showBookList_overdue();
			break;
		default:
			books=BooksManagement.this.library.showBookList_all();
			break;
	...
	public BooksManagement(add_Book_ToAccount lib) {
		...
		btnClose.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				BooksManagement.this.setVisible(false);
		...
		btnDelete.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				if(!BooksManagement.this.library.deleteBook(table.getValueAt(
						row, 2).toString()))
				{
					JOptionPane.showMessageDialog(BooksManagement.this,
		...
		btnUpdate.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				if (row<0)	{
					JOptionPane.showMessageDialog(BooksManagement.this, "Please select a book to update!", "Update Fail", JOptionPane.INFORMATION_MESSAGE);
					return;
				}
				
				String oldISBN = table.getValueAt(row, 2).toString();
				Book tempBook = BooksManagement.this.library
				...
				BooksManagement.this.library.updateBook(oldISBN, tempBook);
				Refresh();
			}
		});
	...
	private Object[][] getAllBookTableData(add_Book_ToAccount library) {
		if (library == null)
			return null;
		else {
